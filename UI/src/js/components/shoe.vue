  ...
  <section>
    ...
    <div class="modal fade" id="InfoShoeModal" tabindex="-1" role="dialog" aria-labelledby="InfoShoeModalLabel"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="InfoShoeModalLabel">Change Brand</h5>
            <button type="button" class="btn btn-close" data-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="input-group input-group-md mb-3">
              ...
              <input type="text" v-model="selectedShoe.Id" class="form-control js-cn" aria-label="Small"
                     aria-describedby="InfoBrandId" :placeholder=selectedShoe.Id readonly>
            </div>
            <div class="input-group input-group-md mb-3">
              <div class="input-group-prepend">
